...
class SetNormalClass {
  constructor() {
    this.setObject = new Set();
    this.setDifferentObject = new Set();
  }
...
const ezerUgyanolyanElemImmutableSet =
  "Ezer ugyanolyan elem hozzáadása az immutable Sethez";
...
const ezerElemImmutableSet =
  "Ezer különböző elem hozzáadása az immutable Sethez";
...
const benneVanImmutableSet =
  "Ezer különböző elemű immutable Setből egy elem keresés";
...
const torlesImmutableSet =
  "Ezer különböző elemű immutable Setből egy elem törlése";
